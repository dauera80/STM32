...
#define SET_CELLULAR_APP_MSG_TYPE(msg, type)  ((msg) = ((((uint32_t)(msg)) & 0x00FFFFFFU) | (((uint32_t)(type))<<24)))
#define SET_CELLULAR_APP_MSG_ID(msg,     id)  ((msg) = ((((uint32_t)(msg)) & 0xFF00FFFFU) | (((uint32_t)(id))<<16)))
#define SET_CELLULAR_APP_MSG_DATA(msg, data)  ((msg) = ((((uint32_t)(msg)) & 0xFFFF0000U) | ((uint32_t)(data))))
...
#define GET_CELLULAR_APP_MSG_DATA(msg)        ((uint16_t)(((uint32_t)(msg)) & 0x0000FFFFU))

...
{
  /* no need to call CELLULAR_APP_DISPLAY_LINK_IN()/_OUT */
...
{
  sFONT *p_font = UTIL_LCD_GetFont(); /* Get the Font used */
...
{
  uint32_t result = 0U; /* Font unknown */
  sFONT *p_font = UTIL_LCD_GetFont(); /* Get the Font used */
...
{
  bool result; /* false: display init NOK, true: display init OK */
...
{
  bool result = false; /* false: display de-init NOK, true: display de-init OK */

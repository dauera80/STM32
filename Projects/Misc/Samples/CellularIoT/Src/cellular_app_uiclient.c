                                                          ...
                                                          void *const p_callback_ctx)
{
  ...
  {
    SET_CELLULAR_APP_MSG_TYPE(msg_queue, msg_type);
    SET_CELLULAR_APP_MSG_ID(msg_queue, msg_id);
    /* Send the message */
      ...
      && (cellular_app_uiclient_screen_state == UICLIENT_SCREEN_CELLULAR_INFO))
  {
    ...
    if (cellular_app_uiclient_cellular_info.ip_addr.addr != 0U)
    {
      ...
      (void)sprintf((CRC_CHAR_t *)&cellular_app_uiclient_string_tmp[0], "%hhu.%hhu.%hhu.%.hhu",
                    (uint8_t)(COM_IP4_ADDR1(&cellular_app_uiclient_cellular_info.ip_addr)),
                    (uint8_t)(COM_IP4_ADDR2(&cellular_app_uiclient_cellular_info.ip_addr)),
                    (uint8_t)(COM_IP4_ADDR3(&cellular_app_uiclient_cellular_info.ip_addr)),
                    (uint8_t)(COM_IP4_ADDR4(&cellular_app_uiclient_cellular_info.ip_addr)));
      p_string2 = &cellular_app_uiclient_string_tmp[0];
      /* Format the line */
...
void cellular_app_uiclient_init(void)
{
  ...
  cellular_app_uiclient.queue_id = rtosalMessageQueueNew((const rtosal_char_t *)"CELLAPPIOT_QUE_UI_CMD",
  ...
  cellular_app_uiclient_datetime_timer_id = rtosalTimerNew((const rtosal_char_t *)"CELLAPPIOT_TIM_UI_DATETIME",
  ...
  cellular_app_uiclient_sensors_timer_id = rtosalTimerNew((const rtosal_char_t *)"CELLAPPIOT_TIM_UI_SENSOR",

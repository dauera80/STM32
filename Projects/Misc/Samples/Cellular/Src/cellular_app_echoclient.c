...
void cellular_app_echoclient_init(void)
{
  ...
  cellular_app_echoclient_index_mutex_handle = rtosalMutexNew((const rtosal_char_t *)"CELLAPP_MUT_ECHO_IND");
  ...
  for (uint8_t i = 0U; i < ECHOCLIENT_THREAD_NUMBER; i++)
  {
    ...
    cellular_app_echoclient[i].queue_id = rtosalMessageQueueNew((const rtosal_char_t *)"CELLAPP_QUE_ECHO_SOCKET",
